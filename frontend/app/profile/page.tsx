    ...
    return (
        <React.Fragment>
            ...
            <div className='w-full md:h-screen h-full min-h-screen flex flex-col items-center bg-black p-5 relative'>
                ...
                <div className='flex flex-col w-full min-h-full my-auto justify-start rounded-2xl bg-[#E6E4D5] scrollHide overflow-y-auto shadow-md'>
                    ...
                    {authenticated ? (
                        <div className='flex flex-col h-full w-full items-center'>
                            ...
                            <div className='flex flex-col w-full md:px-28 px-10 h-auto items-center justify-center mt-10'>
                                ...
                                <div className='w-full h-auto flex flex-row flex-wrap gap-6 my-10'>
                                        ...
                                        userData?.files.map((file: any, index: any) => (
                                            <div key={index} className="border border-white shadow text-base flex flex-col gap-5 relative overflow-hidden">
                                                {file.endsWith('.pdf') ? (
                                                    <iframe
                                                        src={file}
                                                        className="w-96 h-64 border-none"
                                                    ...
                                                    <Image
                                                        ...
                                                        width={300}
                                                        height={300}
                                                        className='w-96 h-64 object-cover relative'
                                                    />
                                                )}
